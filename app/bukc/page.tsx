    ...
    return(
        ...
        <div className="md:mx-5 mx-3 flex flex-col md:gap-0 gap-5">
            ...
            <div>
                ...
                <p className="text-white">Inorder to participate you must hold a valid Competitive Membership for the society as well as a TeamSurrey Membership.
                ...
                Inorder to book a slot for the trials you can contact us via <a href="mailto:ussu.karting@surrey.ac.uk" className="text-gray-300 transition-colors hover:text-nile-blue-300">Email</a> or Social Media.
                </p>
            </div>
