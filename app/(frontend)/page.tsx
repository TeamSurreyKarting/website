      ...
      <main className="">
          <Hero>
              <div className="flex flex-col">
                  ...
                  <p className="font-medium text-xl text-center text-white">Surrey University's Home of Motorsports</p>
              </div>
          </Hero>
          <div className="flex flex-col gap-5 ">
              <div className="grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-6 mx-10 my-8 mb-24">
                  <div className="flex flex-col justify-center">
                      ...
                      <button className="bg-lightning-gold-500 w-32 text-center px-5 py-4 rounded-lg mt-5 font-semibold transition-colors hover:bg-nile-blue-100 ">
                          Join Now!
                      </button>
                  </div>
